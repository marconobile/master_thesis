...
def create_train_val_dataloaders(trainset, valset, max_num_node, max_prev_node, num_workers=1, bs_train=None):
    '''
    ...
    train_dataset_loader = DataLoader(train_set, batch_size=bs_train, shuffle=True, num_workers=num_workers)
